...
var WebViewComponent = forwardRef(function (_a, ref) {
    ...
    }), onLoadingStart = _e.onLoadingStart, onShouldStartLoadWithRequest = _e.onShouldStartLoadWithRequest, onMessage = _e.onMessage, viewState = _e.viewState, setViewState = _e.setViewState, lastErrorEvent = _e.lastErrorEvent, onHttpError = _e.onHttpError, onLoadingError = _e.onLoadingError, onLoadingFinish = _e.onLoadingFinish, onLoadingProgress = _e.onLoadingProgress;
