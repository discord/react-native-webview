...
var createOnShouldStartLoadWithRequest = function (loadRequest, originWhitelist, onShouldStartLoadWithRequest, allowOpenURLNonMatchingOrigin) {
    return function (_a) {
...
export var useWebWiewLogic = function (_a) {
    ...
    var onShouldStartLoadWithRequest = useMemo(function () { return createOnShouldStartLoadWithRequest(onShouldStartLoadWithRequestCallback, originWhitelist, onShouldStartLoadWithRequestProp, allowOpenURLNonMatchingOrigin); }, [allowOpenURLNonMatchingOrigin, originWhitelist, onShouldStartLoadWithRequestProp, onShouldStartLoadWithRequestCallback]);
    return {
