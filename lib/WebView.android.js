...
var WebView = /** @class */ (function (_super) {
    ...
    WebView.prototype.render = function () {
        ...
        var webView = (<NativeWebView key="webViewKey" {...otherProps} messagingEnabled={typeof onMessage === 'function' ||
                (messagingWithWebViewKeyEnabled !== null && messagingWithWebViewKeyEnabled !== void 0 ? messagingWithWebViewKeyEnabled : false)} messagingModuleName={this.messagingModuleName} onLoadingError={this.onLoadingError} onLoadingFinish={this.onLoadingFinish} onLoadingProgress={this.onLoadingProgress} onLoadingStart={this.onLoadingStart} onHttpError={this.onHttpError} onRenderProcessGone={this.onRenderProcessGone} onMessage={this.onMessage} onShouldStartLoadWithRequest={this.onShouldStartLoadWithRequest} ref={this.webViewRef} 
