...
var WebViewComponent = forwardRef(function (_a, ref) {
    ...
    var _t = useWebWiewLogic({
        ...
        allowOpenURLNonMatchingOrigin: allowOpenURLNonMatchingOrigin
    }), onLoadingStart = _t.onLoadingStart, onShouldStartLoadWithRequest = _t.onShouldStartLoadWithRequest, onMessage = _t.onMessage, viewState = _t.viewState, setViewState = _t.setViewState, lastErrorEvent = _t.lastErrorEvent, onHttpError = _t.onHttpError, onLoadingError = _t.onLoadingError, onLoadingFinish = _t.onLoadingFinish, onLoadingProgress = _t.onLoadingProgress, onRenderProcessGone = _t.onRenderProcessGone;
    ...
    var NativeWebView = (nativeConfig === null || nativeConfig === void 0 ? void 0 : nativeConfig.component) || RNCWebViewContainer;
    var webView = <NativeWebView key="webViewKey" {...otherProps} messagingEnabled={typeof onMessageProp === 'function' || (messagingWithWebViewKeyEnabled !== null && messagingWithWebViewKeyEnabled !== void 0 ? messagingWithWebViewKeyEnabled : false)} messagingModuleName={messagingModuleName} onLoadingError={onLoadingError} onLoadingFinish={onLoadingFinish} onLoadingProgress={onLoadingProgress} onLoadingStart={onLoadingStart} onHttpError={onHttpError} onRenderProcessGone={onRenderProcessGone} onMessage={onMessage} onShouldStartLoadWithRequest={onShouldStartLoadWithRequest} ref={webViewRef} 
