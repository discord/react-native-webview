...
var WebView = /** @class */ (function (_super) {
    ...
    WebView.prototype.render = function () {
        var _b = this.props, onMessage = _b.onMessage, onShouldStartLoadWithRequestProp = _b.onShouldStartLoadWithRequest, originWhitelist = _b.originWhitelist, renderError = _b.renderError, renderLoading = _b.renderLoading, source = _b.source, style = _b.style, containerStyle = _b.containerStyle, messagingWithWebViewKeyEnabled = _b.messagingWithWebViewKeyEnabled, _c = _b.nativeConfig, nativeConfig = _c === void 0 ? {} : _c, webViewBackgroundColorString = _b.webViewBackgroundColorString, otherProps = __rest(_b, ["onMessage", "onShouldStartLoadWithRequest", "originWhitelist", "renderError", "renderLoading", "source", "style", "containerStyle", "messagingWithWebViewKeyEnabled", "nativeConfig", "webViewBackgroundColorString"]);
        var otherView = null;
        ...
        var webView = (<NativeWebView key="webViewKey" {...otherProps} messagingEnabled={typeof onMessage === 'function' || (messagingWithWebViewKeyEnabled !== null && messagingWithWebViewKeyEnabled !== void 0 ? messagingWithWebViewKeyEnabled : false)} messagingModuleName={this.messagingModuleName} onLoadingError={this.onLoadingError} onLoadingFinish={this.onLoadingFinish} onLoadingProgress={this.onLoadingProgress} onLoadingStart={this.onLoadingStart} onHttpError={this.onHttpError} onRenderProcessGone={this.onRenderProcessGone} onMessage={this.onMessage} onShouldStartLoadWithRequest={this.onShouldStartLoadWithRequest} ref={this.webViewRef} 
        // TODO: find a better way to type this.
        source={resolveAssetSource(source)} style={webViewStyles} webViewBackgroundColorString={webViewBackgroundColorString} {...nativeConfig.props}/>);
