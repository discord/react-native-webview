...
export const useWebWiewLogic = ({
  ...
  onOpenedWindowProp?: (event: WebViewOpenedWindowEvent) => void;
  onClosedWindowProp?: (event: WebViewClosedWindowEvent) => void;
  ...
  const onOpenedWindow = useCallback(
    (event: WebViewOpenedWindowEvent) => {
      onOpenedWindowProp?.(event);
    },
    [onOpenedWindowProp],
  );

  const onClosedWindow = useCallback(
    (event: WebViewClosedWindowEvent) => {
      onClosedWindowProp?.(event);
    },
    [onClosedWindowProp],
  );
  // !Android and iOS Only
